	...
	function percePersonaje()
	{
		...
		*/
		...
		if(muere == 0)
		{
			...
			//Despues de que el personaje obtiene el oro
			//se utiliza una  afirmacion si el personaje ha vuelto al punto en el que incio.
			//si sucede se imprimira en consola un mensaje de "felicidades" y aparecera entregados 1 y cargados 0;
